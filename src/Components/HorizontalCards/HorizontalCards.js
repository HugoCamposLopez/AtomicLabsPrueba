  ...
  return (
    <ContainerCards horizontal={true}>
      <Card>
        ...
        <CustomImage height={'10px'} width={'40%'}source={require('../../assets/PaqueteAtomic/Lines.png')}/>
        ...
        <DetailCard weight1={'700'} text1={'Consultoría '} text2={'Tecnológica'}/>
      ...
      <ImageContainer>
        ...
        <DetailCard weight2={'700'} text1={'Innovacion '} text2={'y creación tecnológica'}/>
        <DetailCard weight1={'700'} text1={'UI / UX'}/>
        <DetailCard weight1={'700'} text1={'Innovación'}/>
        <DotsContainer marginTop={'7.5%'}>
          <CustomImage
          height={'20px'}
          width={'100px'}
      ...
      <Card>
        ...
        <DetailCard weight2={'700'} text1={'Desarrollo tecnológico '} text2={'y creación tecnológica'}/>
        <DetailCard weight1={'700'} text1={'Ciberseguridad'}/>
        <DetailCard weight1={'700'} text1={'Servicios de la nube'}/>
        <DotsContainer marginTop={'7.3%'}>
          <CustomImage
            height={'20px'}
            width={'100px'}
